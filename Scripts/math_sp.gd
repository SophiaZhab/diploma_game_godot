...
var dialog_data_intro = [
	...
	{"speaker": "Математик", "text": "Вітаю у команді.", "portrait": "res://assets/portraits/mathSp.png"},
]
...
var dialog_data_puzzle = [
	{"speaker": "Математик", "text": "В мене до тебе є доручення.", "portrait": "res://assets/portraits/mathSp.png"},
...
func _on_body_entered(body):
	...
	elif body.name == "Player" and Global.dialogs_played.has("cyber_specialist_generator"):
		var dialog_manager = get_node("/root/Second-class/DialogueManager")
		dialog_manager.start_dialog(dialog_data_puzzle)
